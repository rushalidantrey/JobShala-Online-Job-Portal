...
<?php
  ...
  $sql1 = "SELECT * FROM  $table_name  where job_id>41 AND job_id<=46";
  $sql2 = "SELECT * FROM  $table_name  where job_id>46 AND job_id<=51";
...
<div class="pagination">
  ...
  <a href="http://localhost/jobshala/page3.php">3</a>
  <a href="http://localhost/jobshala/page4.php">4</a>
  <a class = "active" href="http://localhost/jobshala/page5.php">5</a>
