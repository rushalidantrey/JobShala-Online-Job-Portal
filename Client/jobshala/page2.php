...
<?php
  ...
  $sql1 = "SELECT * FROM  $table_name  where job_id>11 AND job_id<=16";
  $sql2 = "SELECT * FROM  $table_name  where job_id>16 AND job_id<=21";
...
<div class="pagination">
  ...
  <a class = "active" href="http://localhost/jobshala/page2.php">2</a>
