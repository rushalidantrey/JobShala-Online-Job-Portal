...
<?php
  ...
  $sql1 = "SELECT * FROM  $table_name  where job_id>51 AND job_id<=56";
  $sql2 = "SELECT * FROM  $table_name  where job_id>56 AND job_id<=61";
...
<div class="pagination">
  ...
  <a class = "active" href="http://localhost/jobshala/page6.php">6</a>
