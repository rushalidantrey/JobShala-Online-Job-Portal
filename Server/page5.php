          ...
          while($row = $result1->fetch_assoc())
          {
            echo '<div class="container">
                    <div class="company-details">
                      ...
                      <p>Job ID : '.$row['job_id'].'
                      <div class="Apply-btn" >
                        <form action="http://localhost/final_project/apply_form.php">
...
<div class="pagination">
  ...
  <a href="http://localhost/final_project/page4.php">4</a>
  <a class = "active" href="http://localhost/final_project/page5.php">5</a>
